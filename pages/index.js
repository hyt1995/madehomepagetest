...
const time = 
<div style={{textAlign:"center",width:"600px", height:"auto",padding:"60px"}}>
        ...
        <div style={{backgroundColor:"#000000"}}>
            ...
            <div>
                ...
                <Timeline mode="alternate" style={{padding:"30px 200px 30px 200px",width:"1900px"}}>
                    ...
                    <Carousel autoplay effect="fade" style={{textAlign: "center",width:"700px",height: "300px",lineHeight: "200px",overflow: "hidden"}}>
                        <div>
                    ...
                    <Timeline.Item dot={<LoadingOutlined style={{fontSize:"20px", color: "red"}} />} label={time} style={{padding:"0px"}} >
